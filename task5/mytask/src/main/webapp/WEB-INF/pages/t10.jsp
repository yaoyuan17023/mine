...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        ...
        <div class="item">
            <img alt="Second slide" src="${pageContext.request.contextPath}/t10/imges/123222.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="${pageContext.request.contextPath}/t10/imges/942882.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="${pageContext.request.contextPath}/t10/imges/23333.jpg">
        </div>
...
<div class="main container">
    ...
    <div class="main-a row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="${pageContext.request.contextPath}/t10/imges/453254312.png">${total}<br>
                <span class="up-3">累计在线学习人数</span>
            </p>
            <p>
                <img src="${pageContext.request.contextPath}/t10/imges/453254312.png">${working}<br>
                ...
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        ...
                        <p class="text-left">${students.profession}:${students.introduce}</p>
                            <date:date value="${students.createAt}"/>
                    </div>
                </li>
            </c:forEach>
        </ul>
